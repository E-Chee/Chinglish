...
public class ConversationFlashcardAdapter extends RecyclerView.Adapter<ConversationFlashcardAdapter.MyViewHolder> {
...
//    private List<Vocab> engWords;
    ...
    public ConversationFlashcardAdapter(Context context, List<Vocab> words ) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.conversationflashcard_item, parent, false);
