...
public class ColorsFlashcardAdapter extends RecyclerView.Adapter<ColorsFlashcardAdapter.MyViewHolder> {
...
//    private List<Vocab> engWords;
    ...
    public ColorsFlashcardAdapter(Context context, List<Vocab> words ) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.colorsflashcard_item, parent, false);
